<template>
  <div style="padding:30px">
    <!-- <div style="text-align:center">
      <h3 style="color:#666">科室轮转考核安排一览表</h3>
    </div> -->
    <!-- 添加表格上方过滤条件 -->
    <myfilters
      title="科室轮转考核安排一览表"
...
import { getTraineeAssess } from '@/api/people/trainee'
export default {
  components: {
    myfilters
  },
  ...
  methods: {
    fetchData() {
      getTraineeAssess().then(response => {
