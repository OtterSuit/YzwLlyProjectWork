<template>
  <div class="apply-contaniner">
    ...
    <div class="box">
      ...
      <el-row class="row">
        <el-col :span="6">
          <span class="label">借入科室</span>
          <span class="content">{{ data.applyDepartment }}</span>
        </el-col>
        <el-col :span="6">
      ...
      <el-row>
        <el-col :span="6">
          <span class="label">借出科室</span>
          <span class="content">{{ data.loanDepartment }}</span>
        </el-col>
        <el-col :span="6">
          <span class="label">审批人</span>
          <span class="content">{{ data.approver }}</span>
        </el-col>
        <el-col :span="6">
          <span class="label">审批时间</span>
          <span class="content">{{ data.approvalTime }}</span>
        </el-col>
      </el-row>
    </div>
    <div class="box">
  ...
  data() {
    return {
      data: {
        ...
        loanDepartment: '儿二科',
        approver: '陈晓晓',
        approvalTime: '2020.08.10 09:54:12'
      },
      tableData: [
        {
          packageNum: '10001',
